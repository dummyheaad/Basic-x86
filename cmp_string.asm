...
segment .data
    str1 db "Hellaaaaaa", 0x00              ; string pertama yang akan dibandingkan
    len_str1 equ $ - str1                   ; panjang string pertama
    str2 db "Hello", 0x00                   ; string kedua yang akan dibandingkan
    len_str2 equ $ - str2                   ; panjang string kedua
    res db "Comparison 3 first character between %s and %s = %d", 0x0a, 0x00
    len_res equ $ - res
    tc equ 3                                ; jumlah karakter yang akan dibandingkan
